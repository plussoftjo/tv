...
echo "</tr></tbody>";
if ($dataarray[148]!='' and $dataarray[148]!=''){ //ram
...
?>
	...
	<?php echo $dataarray[148]; ?>
    </td></tr></tbody>
<?php } 
if ($dataarray[149]!='' and $dataarray[150]!=''){ //cata
?>
	<tbody><tr><td class="empty" colspan="12"></td></tr></tbody>
    <tbody class="goods"><tr><th><?php echo REPORT_INFORMATION; ?></th><td style="text-align:right" colspan="11">
	<img class="unit g<?php echo $dataarray[149]; ?>Icon" src="img/x.gif" />
	<?php echo $dataarray[150]; ?>
    </td></tr></tbody>
<?php }
if ($dataarray[151]!='' and $dataarray[152]!=''){ //chief
?>
	<tbody><tr><td class="empty" colspan="12"></td></tr></tbody>
    <tbody class="goods"><tr><th><?php echo REPORT_INFORMATION; ?></th><td style="text-align:right" colspan="11">
	<img class="unit u<?php echo $dataarray[151]; ?>" src="img/x.gif" />
...
<?php } ?>
<?php if ($dataarray[153]!='' and $dataarray[154]!=''){ //spy
?>
    <tbody><tr><td class="empty" colspan="12"></td></tr></tbody>
    <tbody class="goods"><tr><th><?php echo REPORT_INFORMATION; ?></th><td style="text-align:right" colspan="11">
