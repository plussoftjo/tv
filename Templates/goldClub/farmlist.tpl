...
$lastatk = mysql_query("SELECT * FROM `".TB_PREFIX."movement` WHERE `from` = '".$village->wid."' ORDER BY endtime DESC LIMIT 1");
$lastatk = mysql_fetch_array($lastatk);
if((time()-$lastatk['endtime'])>10){
?>
	<div class="markAll">
...
<?php
	...
	$uurover = $generator->getTimeFormat(($lastatk['endtime']-time())+1);
	echo "<div class=\"markAll\">شما قادر به انتخاب همه در <b><span id=\"timer1\">".$uurover."</span></b> دیگر هستید.</div>";
}
?>
	<div class="addSlot">
