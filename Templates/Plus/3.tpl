...
if(isset($_GET['action']) && $_GET['action']=='ordoogah'){
	...
	if($session->gold >= 10 && $check['f39'] < 20) {	
...
<table class="plusFunctions" cellpadding="1" cellspacing="1">
	<thead>
		...
		<tr>
			<td>توضیح</td>
			<td>مدت زمان</td>
			<td>سکۀ طلای  <?php echo تراوین?></td>
			<td>عمل</td>
		</tr>
	</thead>
	<tbody>
...
?>
			...
			<td class="cost"><img src="img/x.gif" class="gold" alt="سکۀ طلای  <?php echo تراوین?>">10</td>
			<td class="act">
<?php
    $MyGold = mysql_query("SELECT * FROM ".TB_PREFIX."users WHERE `username`='".$session->username."'") or die(mysql_error());
    $golds = mysql_fetch_array($MyGold);
...
?>               
			...
			<td class="cost"><img src="img/x.gif" class="gold" alt="سکۀ طلای <?php echo تراوین?>">5</td>
			<td class="act">
<?php
...
if (mysql_num_rows($MyGold)) {
 ...
 ?>
			...
			<td class="dur">فوری</td>
			<td class="cost"><img src="img/x.gif" class="gold" alt="سکۀ طلای <?php echo NAME_FA?>">10</td>
			<td class="act">
<?php
if (mysql_num_rows($MyGold)) {
    if($village->resarray['f39'] < 20){
        if($golds['gold'] > 9) {
            ...
            echo '<a href="plus.php?s=1"><span class="none">طلا کم است</span>';
		}
	}else{
...
?>
                        ...
                        <tr>
			<td class="desc">خرید جمعیت.(به اندازه 100)</td>
			<td class="dur">فوری</td>
			<td class="cost"><img src="img/x.gif" class="gold" alt="سکۀ طلای <?php echo تراوین?>">25</td>
			<td class="act">
<?php
if (mysql_num_rows($MyGold)) {
    if($golds['gold'] > 9) {
		echo "<button type=\"button\" value=\"خرید\" onclick=\"window.location.href = 'buypop.php'; return false;\"><div class=\"button-container\"><div class=\"button-position\"><div class=\"btl\"><div class=\"btr\"><div class=\"btc\"></div></div></div><div class=\"bml\"><div class=\"bmr\"><div class=\"bmc\"></div></div></div><div class=\"bbl\"><div class=\"bbr\"><div class=\"bbc\"></div></div></div></div><div class=\"button-contents\">خرید</div></div></button>";
} else {
    echo '<a href="plus.php?s=1"><span class="none">طلا کم است</span>';
    }
}
 ?>
		...
		<tr>
			<td class="desc">خرید یک انبار با ظرفیت 800000 منابع .</td>
			<td class="dur">فوری</td>
			<td class="cost"><img src="img/x.gif" class="gold" alt="سکۀ طلای <?php echo تراوین?>">10</td>
			<td class="act">
<?php
if (mysql_num_rows($MyGold)) {
    if($golds['gold'] > 9) {
		echo "<button type=\"button\" value=\"خرید\" onclick=\"window.location.href = 'buy100k.php'; return false;\"><div class=\"button-container\"><div class=\"button-position\"><div class=\"btl\"><div class=\"btr\"><div class=\"btc\"></div></div></div><div class=\"bml\"><div class=\"bmr\"><div class=\"bmc\"></div></div></div><div class=\"bbl\"><div class=\"bbr\"><div class=\"bbc\"></div></div></div></div><div class=\"button-contents\">خرید</div></div></button>";
} else {
    echo '<a href="plus.php?s=1"><span class="none">طلا کم است</span>';
    }
}
 ?>
        ...
        <tr>
			<td class="desc">خرید منابع به اندازه تولیدات 1 ساعت این دهکده. (این امکان در دهکده شگفتی جهان کار نمیکند)</td>
			<td class="dur">فوری</td>
			<td class="cost"><img src="img/x.gif" class="gold" alt="سکۀ طلای <?php echo تراوین?>">10</td>
			<td class="act">
<?php
if (mysql_num_rows($MyGold)) {
    if($golds['gold'] > 9) {
		echo "<button type=\"button\" value=\"خرید\" onclick=\"window.location.href = 'plus.php?id=3&action=manabe'; return false;\"><div class=\"button-container\"><div class=\"button-position\"><div class=\"btl\"><div class=\"btr\"><div class=\"btc\"></div></div></div><div class=\"bml\"><div class=\"bmr\"><div class=\"bmc\"></div></div></div><div class=\"bbl\"><div class=\"bbr\"><div class=\"bbc\"></div></div></div></div><div class=\"button-contents\">خرید</div></div></button>";
} else {
    echo '<a href="plus.php?s=1"><span class="none">طلا کم است</span>';
    }
}
 ?>
                ...
                <tr>
			<td class="desc">به اندازه یک انبار سطح 20 ،در این دهکده منابع خریداری کن.(این امکان در دهکده شگفتی جهان کار نمیکند)</td>
			<td class="dur">فوری</td>
			<td class="cost"><img src="img/x.gif" class="gold" alt="سکۀ طلای <?php echo تراوین?>">20</td>
			<td class="act">
<?php
if (mysql_num_rows($MyGold)) {
    if($golds['gold'] > 9) {
		echo "<button type=\"button\" value=\"خرید\" onclick=\"window.location.href = 'buyresources.php'; return false;\"><div class=\"button-container\"><div class=\"button-position\"><div class=\"btl\"><div class=\"btr\"><div class=\"btc\"></div></div></div><div class=\"bml\"><div class=\"bmr\"><div class=\"bmc\"></div></div></div><div class=\"bbl\"><div class=\"bbr\"><div class=\"bbc\"></div></div></div></div><div class=\"button-contents\">خرید</div></div></button>";
} else {
    echo '<a href="plus.php?s=1"><span class="none">طلا کم است</span>';
    }
}
...
بصورت فوری تمام کن (در مورد اقامتگاه و قصر کار نمی کند).</td>
			<td class="dur">فوری</td>
			<td class="cost"><img src="img/x.gif" class="gold" alt="سکۀ طلای <?php echo تراوین?>">2</td>
			<td class="act">
<?php
if (mysql_num_rows($MyGold)) {
	if($golds['gold'] > 1) {
 ...
 ?>
			...
			<td class="dur">فوری</td>
			<td class="cost"><img src="img/x.gif" class="gold" alt="سکۀ طلای  <?php echo تراوین?>">3</td>
			<td class="act link">
            <?php
        ...
        <tr>
				<td class="desc">مبادلۀ سکۀ طلای  <?php echo تراوین?> و سکۀ نقرۀ  <?php echo تراوین?></td>
				<td class="dur">فوری</td>
				<td class="cost"><img src="img/x.gif" class="gold" alt="سکۀ طلای <?php echo تراوین?>"></td>
				...
				<td class="act arrow" style="text-align: right"><a class="arrow" href="plus.php?id=0">انتقال</a></td>
                        ...
                        <tr>
				<td class="desc">ذخیره سکۀ طلای تراوین(در حال تکمیل)
				<td class="dur">فوری</td>
				<td class="cost"><img src="img/x.gif" class="gold" alt="سکۀ طلای <?php echo تراوین?>"></td>
				<td class="act arrow" style="text-align: right"><a class="arrow" href="plus.php?id=29">ذخیره</a></td>
			</tr>
                        <tr>
				<td class="desc">دریافت سکه های ذخیره شده(در حال تکمیل)
				<td class="dur">فوری</td>
				<td class="cost"><img src="img/x.gif" class="gold" alt="سکۀ طلای <?php echo تراوین?>"></td>
				<td class="act arrow" style="text-align: right"><a class="arrow" href="plus.php?id=30">دریافت</a></td>
			</tr>
        </tbody>
</table>
<h4 class="spacer">کلوپ طلایی  <?php echo تراوین?></h4>
<table class="plusFunctions" cellpadding="1" cellspacing="1">
		<thead>
			<tr>
				<td>توضیح</td>
...
جز امکانات کلوپ طلایی نمی باشد.
				...
				<td class="cost"><img src="img/x.gif" class="gold" alt="سکۀ طلای  <?php echo تراوین?>">50</td>
				<td class="act">
<?php
if($session->gold >= 50){
	if($golds['goldclub'] == 0) {
