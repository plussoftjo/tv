...
و دهکدۀ دومی برای خود بسازد برای شما سکۀ طلای <?php echo تراوین?> جایزه 
داده 
خواهد شد که قادر به استفاده از این سکه های طلای  <?php echo تراوین?> 
مانند سکه های طلای  <?php echo تراوین?> خریداری 
شده خواهید بود.
<br><br>
...
بنا کرد، برای شما <img src="img/x.gif" class="gold" alt="سکۀ طلای  <?php echo تراوین?>"><b>50</b> داده خواهد شد.</p>
