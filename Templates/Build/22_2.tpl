...
<div class=\"clear\">&nbsp;</div>
                    ...
                    echo "<br><div class=\"contractLink\"><span class=\"none\">منابع کافی ~ Available on ".$time[1]." </span></div>
</div>
<div class=\"clear\">&nbsp;</div>
</div></div>";
                    echo "<div class=\"clear\">&nbsp;</div></div></div>";
                ...
                echo "<br><div class=\"contractLink\"><span class=\"none\">
                    در حال حاضر یک تحقیق در حال انجام است</span></div></div></div></div>
                    <div class=\"clear\">&nbsp;</div>
                    </div></div>";
                }
                else {
...
if($success == 0) {
echo "<div class=\"build_details researches\"><div class=\"noResearchPossible\"><span class=\"none\">در حال حاضر هیچ نیرویی برای تحقیق وجود ندارد لطفا به گزینه بیشتر مراجعه کنید.</span></div></div>";
}
?>		
<?php
if($fail > 0) { 
    ...
    <div id=\"researchFuture\" class=\"researches hide \">";
	 ...
	 echo"</span><div class=\"clear\"></div></div></div><div class=\"contractLink\"><a href=\"#\">دارالفنون</a><span class=\"level\"> Level 5</span>, <a href=\"#\">اصطبل</a><span class=\"level\"> Level 5</span></div></div><div class=\"clear\"></div></div><hr>";
     }
	 ...
	 echo"</span><div class=\"clear\"></div></div></div><div class=\"contractLink\"><a href=\"#\">دارالفنون</a><span class=\"level\"> level 15</span>, <a href=\"#\">اصطبل</a><span class=\"level\"> level 10</span></div></div><div class=\"clear\"></div></div><hr>";
     }
	 ...
	 echo"</span><div class=\"clear\"></div></div></div><div class=\"contractLink\"><a href=\"#\">دارالفنون</a><span class=\"level\"> Level 10</span>, <a href=\"#\">کارگاه</a><span class=\"level\"> Level 1</span></div></div><div class=\"clear\"></div></div><hr>";
     }
	 ...
	 echo"</span><div class=\"clear\"></div></div></div><div class=\"contractLink\"><a href=\"#\">دارالفنون</a><span class=\"level\"> Level 15</span>, <a href=\"#\"> کارگاه </a><span class=\"level\"> Level 10</span></div></div><div class=\"clear\"></div></div><hr>";
     }
	 ...
	 echo"</span><div class=\"clear\"></div></div></div><div class=\"contractLink\"><a href=\"#\">دارالفنون</a><span class=\"level\"> Level 20</span>, <a href=\"#\">اردوگاه</a><span class=\"level\"> Level 5</span></div></div><div class=\"clear\"></div></div>";
     }
?>
