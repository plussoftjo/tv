...
<div class=\"clear\">&nbsp;</div>
                    ...
                    echo "<br><div class=\"contractLink\"><span class=\"none\">منابع کافی ~ Enough at".$time[1]."</span></div>
</div>
<div class=\"clear\">&nbsp;</div>
</div></div>";
                    echo "<div class=\"clear\">&nbsp;</div></div></div>";
...
<?php if($fail > 0) { 
    ...
    <div id=\"researchFuture\" class=\"researches hide \">";
	 ...
	 echo"</span><div class=\"clear\"></div></div></div><div class=\"contractLink\"><a href=\"#\">دارالفنون</a><span class=\"level\"> Level 5</span>, <a href=\"#\">اصطبل</a><span class=\"level\"> Level 3</span></div></div><div class=\"clear\"></div></div><hr>";
     }
