...
echo '<img class="ww g40_1" src="gpack/travian_Travian_4.0_41/img/g/g40_1-rtl.gif" alt="شگفتی جهان">'; }
if($village->resarray['f99'] >= 40 && $village->resarray['f99'] <= 59) {
echo '<img class="ww g40_2" src="gpack/travian_Travian_4.0_41/img/g/g40_2-rtl.gif" alt="شگفتی جهان">'; }
if($village->resarray['f99'] >= 60 && $village->resarray['f99'] <= 79) {
echo '<img class="ww g40_3" src="gpack/travian_Travian_4.0_41/img/g/g40_3-rtl.gif" alt="شگفتی جهان">'; }
if($village->resarray['f99'] >= 80 && $village->resarray['f99'] <= 89) {
echo '<img class="ww g40_4" src="gpack/travian_Travian_4.0_41/img/g/g40_4-rtl.gif" alt="شگفتی جهان">'; }
if($village->resarray['f99'] >= 90 && $village->resarray['f99'] <= 100) {
echo '<img class="ww g40_5" src="gpack/travian_Travian_4.0_41/img/g/g40_5-rtl.gif" alt="شگفتی جهان">'; }
}
?>
