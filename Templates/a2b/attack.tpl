...
$id = $database->addA2b($ckey,$_POST['timestamp'],$process['0'],$t1,$t2,$t3,$t4,$t5,$t6,$t7,$t8,$t9,$t10,$t11,$process['c']);
...
<input name="timestamp" value="<?php echo $_POST['timestamp']; ?>" type="hidden"> 

<input name="timestamp_checksum" value="<?php echo $_POST['timestamp_checksum']; ?>" type="hidden"> 
