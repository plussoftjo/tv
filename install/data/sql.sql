...
CREATE TABLE IF NOT EXISTS `%PREFIX%enforcement` (
  ...
  `u12` int(11) NOT NULL DEFAULT '0',
  `u13` int(11) NOT NULL DEFAULT '0',
  `u14` int(11) NOT NULL DEFAULT '0',
  `u15` int(11) NOT NULL DEFAULT '0',
  `u16` int(11) NOT NULL DEFAULT '0',
  `u17` int(11) NOT NULL DEFAULT '0',
  `u18` int(11) NOT NULL DEFAULT '0',
  `u19` int(11) NOT NULL DEFAULT '0',
  `u20` int(11) NOT NULL DEFAULT '0',
  `u21` int(11) NOT NULL DEFAULT '0',
  `u22` int(11) NOT NULL DEFAULT '0',
  `u23` int(11) NOT NULL DEFAULT '0',
  `u24` int(11) NOT NULL DEFAULT '0',
  `u25` int(11) NOT NULL DEFAULT '0',
  `u26` int(11) NOT NULL DEFAULT '0',
  `u27` int(11) NOT NULL DEFAULT '0',
  `u28` int(11) NOT NULL DEFAULT '0',
  `u29` int(11) NOT NULL DEFAULT '0',
  `u30` int(11) NOT NULL DEFAULT '0',
  `u31` int(11) NOT NULL DEFAULT '0',
  `u32` int(11) NOT NULL DEFAULT '0',
  `u33` int(11) NOT NULL DEFAULT '0',
  `u34` int(11) NOT NULL DEFAULT '0',
  `u35` int(11) NOT NULL DEFAULT '0',
  `u36` int(11) NOT NULL DEFAULT '0',
  `u37` int(11) NOT NULL DEFAULT '0',
  `u38` int(11) NOT NULL DEFAULT '0',
  `u39` int(11) NOT NULL DEFAULT '0',
  `u40` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `%PREFIX%hero` (
  ...
  `goriz` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`heroid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1;
