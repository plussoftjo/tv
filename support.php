			...
			<div id="header">
				<div id="mtop">
					<a id="logo" href="<?php include("adress.txt")?>" target="_blank" title="<?php echo SERVER_NAME; ?>"></a>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;		<img src="gpack/travian_Travian_4.0_41/img/layout/T-logo.png"title="مسابقه قهرمانی <?php echo NAME_FA;?>">	
					<div class="clear"></div>
				</div>
			</div>
			<div id="mid">
...
<div id="side_navi">
	<ul>
		<li>
			<a href="<?php include("adress.txt")?>" title="<?php echo HOME; ?>"><?php echo HOME; ?></a>
		</li>
...
<table class="form_table form_tablel_support" width="100%"><tbody><tr>
	...
	<td class="form_table_element form_table_element_support_category">
		<select id="support_category" name="category">
			...
			<option value="3">سوالات مربوط به پلاس</option>
		</select>
	</td></tr></tbody>
</table>
</div>
