...
<h1 class="titleInHeader">مدال ها<?php if($session->access == ADMIN) { echo " <a href=\"\"></a>"; } ?></h1>
...
<div title="" <?php if(!isset($_GET['tid']) || (isset($_GET['tid']) && ($_GET['tid'] == 1 || $_GET['tid'] == 31 || $_GET['tid'] == 32 || $_GET['tid'] == 7))) { echo "class=\"container normal\""; } else { echo "class=\"container normal\""; } ?>> 
					...
					<div class="content"><a href="Mssg.php"><span class="tabItem">نامه همگانی</span></a></div> 
				</div> 
				...
				<div title="" <?php if(isset($_GET['tid']) && $_GET['tid'] == 8) { echo "class=\"container active\""; } else { echo "class=\"container active\""; } ?>> 
					<div class="background-start">&nbsp;</div> 
					<div class="background-end">&nbsp;</div> 
					<div class="content"><a href="meDa.php"><span class="tabItem">مدال ها</span></a></div> 
				</div> 
				<div title="" <?php if(isset($_GET['tid']) && $_GET['tid'] == 0) { echo "class=\"container normal\""; } else { echo "class=\"container normal\""; } ?>> 
					<div class="background-start">&nbsp;</div> 
					<div class="background-end">&nbsp;</div> 
...
<h4 class="round">مدال ها</h4>
<h3>مدال های هفته <?php echo $week; ?></h3><Br /><Br />
براي دادن مدال هاي اين هفته به بازيکن ها لطفا تاييد کنيد --> <a href="?giveout">تاييد</a><br/><font color="#FF0000">نکته: اين عمليات کمي طول خواهد کشيد</font>
<?php } ?>
