...
<h2><?php echo '<a href="plus.php?id=3"><img src="gold.png" alt="زاب تشگ" title="You currently have: '.$session->gold.' gold"/></a> You have: '.$session->gold.' Gold'; ?></h2>
...
<input type="submit" name="submit" value="اتمام فوری آموزش تمام نیروهای در حال ساخت این دهکده"> 
</td></tr> 
</table> 
</form> 
<?php
