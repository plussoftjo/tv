...
define("HERO_IMG","قهرمان");
define("ADVENTURE","ماجراجویی");
define("ADVENTURE_HELP","قهرمان خود را برای ماجراجویی بفرستید. اگر شانس با شما یار باشد، برای قهرمان خود لوازم و تجهیزات پیدا خواهید کرد.");
define("ADVENTURE_TROOP","لشکریان");
define("ADVENTURE_TIME","مدت زمان");
define("ADVENTURE_SEND","ارسال ماجراجویی");
define("ADVENTURE_HELP_HERO","قهرمان شما در حال حاضر در دهکده نیست.");
define("ADVENTURE_HELP_HERO_MORDE","قهرمان شما مرده است.");
define("ADVENTURE_HELP_ORDOGAH","اردوگاه بساز");
define("HELP_HELP","راهنما");
define("HELP_2","پاسخ های ");
define("QUEST_QUEST","به وظیفه");
define("QUEST_QOUT","بستن");
