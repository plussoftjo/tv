...
define("LOGIN_LOWRES_OPTION","تــراوین با ویرایش 4");
define("LOGIN_LOWRES_DESC","(سرعت اینترنت کمتر)");
define("LOGIN_LOWRES_NOTICE","(به سرور persiantrav خوش آمدید)");
...
define("REGISTER_STARTER","اگر به تازگی با WARTRA آشنا شده اید، توصیه می شود که نژاد گول را انتخاب کنید.");
...
define("HEADER_GOLD","سکه طلای persiantrav");
define("HEADER_SILVER","سکه نقره persiantrav");
...
define("NAME_FA","big tra");
define("HERO_IMG","فهرمان");
